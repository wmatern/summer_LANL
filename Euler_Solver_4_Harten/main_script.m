...
RHO_New (j,i) = RHO(j,i) - Cx*(MXx(j-2,i-1)-MXx(j-2,i-2))...
    ...
    - wminusx(RHO,U,V,j,i,numinusx,TVD).*(RHO(j  ,i  )-RHO(j  ,i-1))...
    + wplusx (RHO,U,V,j,i,nuplusx ,TVD).*(RHO(j  ,i+1)-RHO(j  ,i  ))...
    - wminusy(RHO,U,V,j,i,numinusy,TVD).*(RHO(j  ,i  )-RHO(j-1,i  ))...
    + wplusy (RHO,U,V,j,i,nuplusy ,TVD).*(RHO(j+1,i  )-RHO(j  ,i  ));
...
MX_New  (j,i) = MX(j,i) - Cx*((MXx(j-2,i-1).^2./RHOx(j-2,i-1)+Px(j-2,i-1))...
    ...
    - wminusx(MX,U,V,j,i,numinusx,TVD).*(MX(j  ,i  )-MX(j  ,i-1))...
    + wplusx (MX,U,V,j,i,nuplusx ,TVD).*(MX(j  ,i+1)-MX(j  ,i  ))...
    - wminusy(MX,U,V,j,i,numinusy,TVD).*(MX(j  ,i  )-MX(j-1,i  ))...
    + wplusy (MX,U,V,j,i,nuplusy ,TVD).*(MX(j+1,i  )-MX(j  ,i  ));
...
MY_New  (j,i) = MY(j,i) - Cy*((MYy(j-1,i-2).^2./RHOy(j-1,i-2)+Py(j-1,i-2))...
    ...
    - wminusx(MY,U,V,j,i,numinusx,TVD).*(MY(j  ,i  )-MY(j  ,i-1))...
    + wplusx (MY,U,V,j,i,nuplusx ,TVD).*(MY(j  ,i+1)-MY(j  ,i  ))...
    - wminusy(MY,U,V,j,i,numinusy,TVD).*(MY(j  ,i  )-MY(j-1,i  ))...
    + wplusy (MY,U,V,j,i,nuplusy ,TVD).*(MY(j+1,i  )-MY(j  ,i  ));
...
E_New   (j,i) = E(j,i) - Cx*(((Ex(j-2,i-1)+Px(j-2,i-1)).*MXx(j-2,i-1)./RHOx(j-2,i-1)) ...
    ...
    - wminusx(E,U,V,j,i,numinusx,TVD).*(E(j  ,i  )-E(j  ,i-1))...
    + wplusx (E,U,V,j,i,nuplusx ,TVD).*(E(j  ,i+1)-E(j  ,i  ))...
    - wminusy(E,U,V,j,i,numinusy,TVD).*(E(j  ,i  )-E(j-1,i  ))...
    + wplusy (E,U,V,j,i,nuplusy ,TVD).*(E(j+1,i  )-E(j  ,i  ));
