...
U_d_p   (j,i) = dt/dx*((abs(U_halfp(j,i))-U_halfp(j,i).^2).*...
    d_px(j,i  ,abs(MX_New)) - U_halfp(j,i).*V_halfp(j,i).*d_py(j,i  ,abs(MX_New)));
U_d_m   (j,i) = dt/dx*((abs(U_halfm(j,i))-U_halfm(j,i).^2).*...
    d_px(j,i-1,abs(MX_New)) - U_halfm(j,i).*V_halfm(j,i).*d_py(j,i-1,abs(MX_New)));
V_d_p   (j,i) = dt/dy*((abs(V_halfp(j,i))-V_halfp(j,i).^2).*...
    d_py(j  ,i,abs(MX_New)) - U_halfp(j,i).*V_halfp(j,i).*d_px(j  ,i,abs(MX_New)));
V_d_m   (j,i) = dt/dy*((abs(V_halfm(j,i))-V_halfm(j,i).^2).*...
    d_py(j-1,i,abs(MX_New)) - U_halfm(j,i).*V_halfm(j,i).*d_px(j-1,i,abs(MX_New)));
...
U_d_m   (j,i) = dt/dx*((abs(U_halfm(j,i))-U_halfm(j,i).^2).*...
    d_px(j,i-1,abs(MY_New)) - U_halfm(j,i).*V_halfm(j,i).*d_py(j,i-1,abs(MY_New)));
V_d_p   (j,i) = dt/dy*((abs(V_halfp(j,i))-V_halfp(j,i).^2).*...
    d_py(j  ,i,abs(MY_New)) - U_halfp(j,i).*V_halfp(j,i).*d_px(j  ,i,abs(MY_New)));
V_d_m   (j,i) = dt/dy*((abs(V_halfm(j,i))-V_halfm(j,i).^2).*...
    d_py(j-1,i,abs(MY_New)) - U_halfm(j,i).*V_halfm(j,i).*d_px(j-1,i,abs(MY_New)));
